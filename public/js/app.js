...
(function() {
  define(['utilities/window', 'globals', 'worker', 'ephemeris', 'ellipse', 'util', 'jquery', 'detector', 'three', 'domevent', 'dragpan-controls', 'window-resize', 'vector3', 'full-screen', 'scene', 'sprite', 'cube-geometry', 'mesh', 'quaternion', 'webglrenderer', 'shader-utils', 'trackball', 'perspective-camera', 'image-utils' ,'particle-system'], function(window) {
      ...
      function init(){
        ...
        */
        ...
        if (using_webgl) {
          ...
          var texture = THREE.ImageUtils.loadTexture("/img/sunsprite.png");
      ...
      function createParticleSystem() {
        ...
        uniforms = {
          ...
          small_roid_texture:
            { type: "t", value: THREE.ImageUtils.loadTexture("/img/cloud4.png") },
          small_roid_circled_texture:
            { type: "t", value: THREE.ImageUtils.loadTexture("/img/cloud4-circled.png") }
        };
