...
(function() {
  define(['utilities/window', 'globals', 'worker', 'ephemeris', 'ellipse', 'util', 'jquery', 'detector', 'three', 'domevent', 'dragpan-controls', 'window-resize', 'vector3', 'full-screen', 'scene', 'sprite', 'cube-geometry', 'mesh', 'quaternion', 'webglrenderer', 'shader-utils', 'trackball', 'perspective-camera', 'image-utils'], function(window) {
