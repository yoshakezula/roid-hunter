...
(function() {
  define(['utilities/window', 'globals', 'worker', 'ephemeris', 'ellipse', 'util', 'jquery', 'detector', 'three', 'domevent', 'window-resize', 'vector3', 'full-screen', 'scene', 'sprite', 'cube-geometry', 'mesh', 'quaternion', 'webglrenderer', 'shader-utils', 'trackball', 'perspective-camera', 'image-utils' ,'particle-system','leap'], function(window) {
