define(['utilities/window','matrix4','three'],function(window) {
	/**
	...
	window.THREE.Object3D = function () {
	...
	window.THREE.Object3D.prototype = {
	...
	window.THREE.Object3D.defaultEulerOrder = 'XYZ',

	window.THREE.Object3DIdCount = 0;
});